var _a;
import { reactive, computed, watchEffect, toRefs, capitalize, Fragment, warn, ref, inject as inject$1, shallowRef, provide, unref, defineComponent as defineComponent$1, camelize, h, getCurrentInstance as getCurrentInstance$1, isRef, watch, createVNode, toRef, onScopeDispose, effectScope, toRaw, onBeforeUnmount, onMounted, mergeProps, Text, readonly, Transition, resolveDynamicComponent, nextTick, withDirectives, resolveDirective, withCtx, createTextVNode, useSSRContext, onDeactivated, onActivated, TransitionGroup, onBeforeMount, vShow, Teleport, cloneVNode, onBeforeUpdate, vModelText, createSSRApp } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VBtn, _attrs, {
